    ...
    public boolean onDoubleTap(MotionEvent ev) {
        ...
        try {
            ...
            if (scale < photoViewAttacher.getMediumScale()) {
                photoViewAttacher.setScale(photoViewAttacher.getMediumScale(), x, y, false);
            } else if (scale >= photoViewAttacher.getMediumScale() && scale < photoViewAttacher.getMaximumScale()) {
                photoViewAttacher.setScale(photoViewAttacher.getMaximumScale(), x, y, false);
            } else {
                photoViewAttacher.setScale(photoViewAttacher.getMinimumScale(), x, y, false);
            }
