...
public interface IPhotoView {
    ...
    /**
     * 
     * Set width and heigh in intial state for image view
     */
    void setImageViewWithHeight(int width,int height);
    
    /**
     * Crop the image from the right side to left side
     */
    void setImageViewCropRight(PhotoView photoView, int width, int height);
    /**
